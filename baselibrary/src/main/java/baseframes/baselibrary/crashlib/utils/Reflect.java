...
public class Reflect {
    ...
    private Reflect(String className) {
        ...
        try {
            ...
            throw new ReinstateException("Class:" + className + " can not be found!", e.getCause());
        }
    }
        ...
        public Object invoke(Object invoker, Object... params) {
            ...
            if (invoker == null) {
                if ((method.getModifiers() & Modifier.STATIC) == 0)
                    throw new ReinstateException("Invoker can not be null!");
            }
            try {
        ...
        public void set(Object target, Object value) {
            ...
            if (target == null) {
                if ((field.getModifiers() & Modifier.STATIC) == 0)
                    throw new ReinstateException("Target object can not be null!");
            }
            try {
