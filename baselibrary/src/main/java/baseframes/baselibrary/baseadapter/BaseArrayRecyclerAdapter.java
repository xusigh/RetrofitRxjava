...
public abstract class BaseArrayRecyclerAdapter<E,VH extends RecyclerView.ViewHolder>
    ...
    @SuppressWarnings("unused")
    public BaseArrayRecyclerAdapter(int capacity) {
        list = new ArrayList<>(capacity);
    }

    @SuppressWarnings("unused")
    public BaseArrayRecyclerAdapter(Collection<? extends E> collection) {
